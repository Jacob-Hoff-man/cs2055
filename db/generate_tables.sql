...
CREATE TABLE COFFEE(
    ...
    CONSTRAINT C_PK PRIMARY KEY (Coffee_Id)  DEFERRABLE INITIALLY IMMEDIATE,
...
CREATE TABLE STORE(
    ...
    CONSTRAINT S_PK PRIMARY KEY (Store_Number)  DEFERRABLE INITIALLY IMMEDIATE,
...
CREATE TABLE LOYALTY_PROGRAM (
    ...
    CONSTRAINT LOYALTY_PROGRAM_PK PRIMARY KEY (Loyalty_Level)  DEFERRABLE INITIALLY IMMEDIATE,
    CONSTRAINT UQ_Total_Points_Value_Unlocked_At UNIQUE(Total_Points_Value_Unlocked_At) DEFERRABLE INITIALLY IMMEDIATE
);
...
CREATE TABLE CUSTOMER (
    ...
    CONSTRAINT FK_LOYALTY_PROGRAM FOREIGN KEY (Loyalty_Level) REFERENCES LOYALTY_PROGRAM(Loyalty_Level) DEFERRABLE INITIALLY IMMEDIATE
);
...
CREATE TABLE SALE (
  ...
  CONSTRAINT PK_SALE PRIMARY KEY (Purchase_Id)  DEFERRABLE INITIALLY IMMEDIATE,
...
CREATE TABLE PROMOTION(
    ...
    CONSTRAINT P_PK PRIMARY KEY (Promo_Number) DEFERRABLE INITIALLY IMMEDIATE,
